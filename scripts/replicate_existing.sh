...
# ogbl-ppa
python src/run.py --data_name ogbl-ppa --lr 1e-3  --gnn-layers 3 --dim 64  --batch-size 32768 --epochs 75 --eps 5e-5  --gnn-drop 0.1 --dropout 0.1 --pred-drop 0.1 --att-drop 0.1 --feat-drop 0.1 --num-heads 1 --residual  --thresh-1hop 1e-4 --thresh-non1hop 1e-2 --runs 10 --device 0

# ogbl-citation2
python src/run.py --data_name ogbl-citation2 --lr 1e-3  --decay 1 --gnn-layers 3 --dim 64  --batch-size 32768  --epochs 30 --kill_cnt 15 --eps 2.5e-3 --gnn-drop 0.1 --dropout 0.1 --pred-drop 0.1 --att-drop 0.1 --feat-drop 0.1 --num-heads 1 --residual  --thresh-1hop 1e-3 --thresh-non1hop 1e-2  --runs 10 --device 0